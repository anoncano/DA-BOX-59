...
- Over-the-air updates are enabled via Arduino OTA once the board is connected (either to WiFi or AP) so admins can upload new sketches without physical access.
